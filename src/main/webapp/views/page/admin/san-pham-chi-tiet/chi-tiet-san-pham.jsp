...
<div class="container-fluid px-4">
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="post" action="<c:url value="/admin/chi-tiet-san-pham/them-chi-tiet-san-pham"/>">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <table id="datatablesSimple">
                ...
                <tbody>
                <c:forEach items="${chiTietSanPhams}" var="x">
                    <tr>
                        <td>${x.maSanPhamChiTiet}</td>
                        <td>${x.mauSac.tenMauSac}</td>
                        <td>${x.kichThuoc.tenKichThuoc}</td>
                        <td>${x.donGia}</td>
                        <td>${x.soLuong}</td>
                        <td>${x.trangThai ? 'Khả dụng':'Không khả dụng'}</td>
                        <td><a class="btn btn-warning"
                                   href="/admin/chi-tiet-san-pham/cap-nhat-chi-tiet-san-pham/${x.maSanPhamChiTiet}">Sửa</a></td>
